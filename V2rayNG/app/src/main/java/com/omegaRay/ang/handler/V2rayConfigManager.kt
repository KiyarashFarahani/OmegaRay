package com.omegaRay.ang.handler

import android.content.Context
import android.text.TextUtils
import android.util.Log
import com.omegaRay.ang.AppConfig
import com.omegaRay.ang.AppConfig.ANG_PACKAGE
import com.omegaRay.ang.AppConfig.DEFAULT_NETWORK
import com.omegaRay.ang.AppConfig.DNS_ALIDNS_ADDRESSES
import com.omegaRay.ang.AppConfig.DNS_ALIDNS_DOMAIN
import com.omegaRay.ang.AppConfig.DNS_CLOUDFLARE_ADDRESSES
import com.omegaRay.ang.AppConfig.DNS_CLOUDFLARE_DOMAIN
import com.omegaRay.ang.AppConfig.DNS_DNSPOD_ADDRESSES
import com.omegaRay.ang.AppConfig.DNS_DNSPOD_DOMAIN
import com.omegaRay.ang.AppConfig.DNS_GOOGLE_ADDRESSES
import com.omegaRay.ang.AppConfig.DNS_GOOGLE_DOMAIN
import com.omegaRay.ang.AppConfig.DNS_QUAD9_ADDRESSES
import com.omegaRay.ang.AppConfig.DNS_QUAD9_DOMAIN
import com.omegaRay.ang.AppConfig.DNS_YANDEX_ADDRESSES
import com.omegaRay.ang.AppConfig.DNS_YANDEX_DOMAIN
import com.omegaRay.ang.AppConfig.GEOIP_CN
import com.omegaRay.ang.AppConfig.GEOSITE_CN
import com.omegaRay.ang.AppConfig.GEOSITE_PRIVATE
import com.omegaRay.ang.AppConfig.GOOGLEAPIS_CN_DOMAIN
import com.omegaRay.ang.AppConfig.GOOGLEAPIS_COM_DOMAIN
import com.omegaRay.ang.AppConfig.HEADER_TYPE_HTTP
import com.omegaRay.ang.AppConfig.LOOPBACK
import com.omegaRay.ang.AppConfig.PROTOCOL_FREEDOM
import com.omegaRay.ang.AppConfig.TAG_BLOCKED
import com.omegaRay.ang.AppConfig.TAG_DIRECT
import com.omegaRay.ang.AppConfig.TAG_FRAGMENT
import com.omegaRay.ang.AppConfig.TAG_PROXY
import com.omegaRay.ang.AppConfig.WIREGUARD_LOCAL_ADDRESS_V4
import com.omegaRay.ang.AppConfig.WIREGUARD_LOCAL_ADDRESS_V6
import com.omegaRay.ang.dto.ConfigResult
import com.omegaRay.ang.dto.EConfigType
import com.omegaRay.ang.dto.NetworkType
import com.omegaRay.ang.dto.ProfileItem
import com.omegaRay.ang.dto.RulesetItem
import com.omegaRay.ang.dto.V2rayConfig
import com.omegaRay.ang.dto.V2rayConfig.RoutingBean.RulesBean
import com.omegaRay.ang.extension.isNotNullEmpty
import com.omegaRay.ang.fmt.HttpFmt
import com.omegaRay.ang.fmt.Hysteria2Fmt
import com.omegaRay.ang.fmt.ShadowsocksFmt
import com.omegaRay.ang.fmt.SocksFmt
import com.omegaRay.ang.fmt.TrojanFmt
import com.omegaRay.ang.fmt.VlessFmt
import com.omegaRay.ang.fmt.VmessFmt
import com.omegaRay.ang.fmt.WireguardFmt
import com.omegaRay.ang.util.JsonUtil
import com.omegaRay.ang.util.Utils
