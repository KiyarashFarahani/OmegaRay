...
import com.omegaRay.ang.AppConfig.VPN
import com.omegaRay.ang.R
import com.omegaRay.ang.databinding.ActivityMainBinding
import com.omegaRay.ang.dto.EConfigType
import com.omegaRay.ang.extension.toast
import com.omegaRay.ang.handler.AngConfigManager
import com.omegaRay.ang.handler.MigrateManager
import com.omegaRay.ang.handler.MmkvManager
import com.omegaRay.ang.helper.SimpleItemTouchHelperCallback
import com.omegaRay.ang.service.V2RayServiceManager
import com.omegaRay.ang.util.Utils
import com.omegaRay.ang.viewmodel.MainViewModel
...
//                tv_test_state.text = getString(R.string.connection_test_fail)
    ...
    private fun setupViewModel() {
        ...
        mainViewModel.isRunning.observe(this) { isRunning ->
            ...
            if (isRunning) {
                binding.connectButton.backgroundTintList = ColorStateList.valueOf(ContextCompat.getColor(this, R.color.color_connect_button_active))
                setTestState(getString(R.string.connection_connected))
                binding.layoutTest.isFocusable = true
            } else {
                binding.connectButton.backgroundTintList = ColorStateList.valueOf(ContextCompat.getColor(this, R.color.color_connect_button_inactive))
